...
namespace ZombieWar.UI
{
    public class Joystick : MonoBehaviour, IPointerDownHandler, IDragHandler, IPointerUpHandler
    {
        ...
        Color readyColor, cdColor;
        protected bool isReady = true;

        void Awake()
        {
            readyColor = handle.GetComponent<Image>().color;
            cdColor = new Color(readyColor.r / 2, readyColor.g / 2, readyColor.b / 2, 1);
        }
        ...
        {
            handle.GetComponent<Image>().color = readyColor;
            isReady = true;
        }

        public void SetToCdState()
        {
            handle.GetComponent<Image>().color = cdColor;
            isReady = false;
        }
    }
